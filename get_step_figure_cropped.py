...
output_pdf    = os.path.join(output_dir, f"{filter_regex}_step_figure_cropped.pdf")  # ← output filename
# ===========================
...
fig.subplots_adjust(hspace=0.1, wspace=0.1)  # ↓ reduce this value for even tighter stacking
